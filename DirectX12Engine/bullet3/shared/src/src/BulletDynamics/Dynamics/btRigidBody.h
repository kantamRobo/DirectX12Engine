...
#include <../packages/directxtk12_desktop_2017.2021.11.8.1/include/SimpleMath.h>
...
public:
	...
	void applyCentralImpulse(const btVector3& impulse,DirectX::SimpleMath::Vector3& dst)
	{
		BULLET3CONVERTER::ConvertBtVector3toVector3(impulse, dst);
