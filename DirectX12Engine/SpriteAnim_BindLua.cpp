...
int SpriteAnim_BindLua::SetRot(lua_State* L)
{
	...
	if (argc > 0)
	{
		anim.rot = LuaScript::SGetFloat(L, 1);
	}
	else
	{
		LuaScript::SError(L, "SetRot(float rot) not enough arguments!");
	}
	return 0;
}
...
int SpriteAnim_BindLua::SetOpacity(lua_State* L)
{
	...
	if (argc > 0)
	{
		anim.opa = LuaScript::SGetFloat(L, 1);
	}
	else
	{
		LuaScript::SError(L, "SetOpacity(float val) not enough arguments!");
	}
	return 0;
}
int SpriteAnim_BindLua::SetFade(lua_State* L)
{
	...
	if (argc > 0)
	{
		anim.fad = LuaScript::SGetFloat(L, 1);
	}
	else
	{
		LuaScript::SError(L, "SetFade(float val) not enough arguments!");
	}
	return 0;
}
int SpriteAnim_BindLua::SetRepeatable(lua_State* L)
{
	...
	if (argc > 0)
	{
		anim.repeatable = LuaScript::SGetBool(L, 1);
	}
	else
	{
		LuaScript::SError(L, "SetRepeatable(float val) not enough arguments!");
	}
	return 0;
}
int SpriteAnim_BindLua::SetVelocity(lua_State* L)
{
	...
	if (argc > 0)
	{
		...
		{
			LuaScript::SError(L, "SetVelocity(Vector val) argument is not a Vector!");
		}
	}
	else
	{
		LuaScript::SError(L, "SetVelocity(Vector val) not enough arguments!");
	}
	return 0;
}
int SpriteAnim_BindLua::SetScaleX(lua_State* L)
{
	...
	if (argc > 0)
	{
		anim.scaleX = LuaScript::SGetFloat(L, 1);
	}
	else
	{
		LuaScript::SError(L, "SetScaleX(float val) not enough arguments!");
	}
	return 0;
}
int SpriteAnim_BindLua::SetScaleY(lua_State* L)
{
	...
	if (argc > 0)
	{
		anim.scaleY = LuaScript::SGetFloat(L, 1);
	}
	else
	{
		LuaScript::SError(L, "SetScaleY(float val) not enough arguments!");
	}
	return 0;
}
int SpriteAnim_BindLua::SetMovingTexAnim(lua_State* L)
{
	...
	if (argc > 0)
	{
		...
		{
			LuaScript::SError(L, "SetMovingTexAnim(MovingTexAnim data) argument is not a MovingTexAnim!");
		}
	}
	else
	{
		LuaScript::SError(L, "SetMovingTexAnim(MovingTexAnim data) not enough arguments!");
	}
	return 0;
}
int SpriteAnim_BindLua::SetDrawRecAnim(lua_State* L)
{
	...
	if (argc > 0)
	{
		...
		{
			LuaScript::SError(L, "SetDrawRecAnim(DrawRecAnim data) argument is not a DrawRecAnim!");
		}
	}
	else
	{
		LuaScript::SError(L, "SetDrawRecAnim(DrawRecAnim data) not enough arguments!");
	}
	return 0;
}
...
{
	LuaScript::SSetFloat(L, anim.rot);
	return 1;
}
...
{
	LuaScript::SSetFloat(L, anim.opa);
	return 1;
}
int SpriteAnim_BindLua::GetFade(lua_State* L)
{
	LuaScript::SSetFloat(L, anim.fad);
	return 1;
}
int SpriteAnim_BindLua::GetRepeatable(lua_State* L)
{
	LuaScript::SSetBool(L, anim.repeatable);
	return 1;
}
...
{
	LuaScript::SSetFloat(L, anim.scaleX);
	return 1;
}
int SpriteAnim_BindLua::GetScaleY(lua_State* L)
{
	LuaScript::SSetFloat(L, anim.scaleY);
	return 1;
}
...
void SpriteAnim_BindLua::Bind()
{
	...
	{
		initialized = true;
		Luna<SpriteAnim_BindLua>::Register(LuaScript::GetLuaState());
		Luna<MovingTexAnim_BindLua>::Register(LuaScript::GetLuaState());
		Luna<DrawRectAnim_BindLua>::Register(LuaScript::GetLuaState());
	}
}
...
MovingTexAnim_BindLua::MovingTexAnim_BindLua(lua_State* L)
{
	...
	if (argc > 0)
	{
		anim.speedX = LuaScript::SGetFloat(L, 1);
		if (argc > 1)
		{
			anim.speedY = LuaScript::SGetFloat(L, 2);
		}
	}
}
...
int MovingTexAnim_BindLua::SetSpeedX(lua_State* L)
{
	...
	{
		LuaScript::SError(L, "SetSpeedX(float val) not enough arguments!");
	}
	return 0;
}
int MovingTexAnim_BindLua::SetSpeedY(lua_State* L)
{
	...
	if (argc > 0)
	{
		anim.speedY = LuaScript::SGetFloat(L, 1);
	}
	else
	{
		LuaScript::SError(L, "SetSpeedY(float val) not enough arguments!");
	}
	return 0;
}
...
{
	LuaScript::SSetFloat(L, anim.speedX);
	return 1;
}
int MovingTexAnim_BindLua::GetSpeedY(lua_State* L)
{
	LuaScript::SSetFloat(L, anim.speedY);
	return 1;
}
...
int DrawRectAnim_BindLua::SetFrameRate(lua_State* L)
{
	...
	if (argc > 0)
	{
		anim.frameRate = LuaScript::SGetFloat(L, 1);
	}
	else
	{
		LuaScript::SError(L, "SetFrameRate(float val) not enough arguments!");
	}
	return 0;
}
int DrawRectAnim_BindLua::SetFrameCount(lua_State* L)
{
	...
	if (argc > 0)
	{
		anim.frameCount = LuaScript::SGetInt(L, 1);
	}
	else
	{
		LuaScript::SError(L, "SetFrameCount(int val) not enough arguments!");
	}
	return 0;
}
int DrawRectAnim_BindLua::SetHorizontalFrameCount(lua_State* L)
{
	...
	if (argc > 0)
	{
		anim.horizontalFrameCount = LuaScript::SGetInt(L, 1);
	}
	else
	{
		LuaScript::SError(L, "SetHorizontalFrameCount(int val) not enough arguments!");
	}
	return 0;
}
...
{
	LuaScript::SSetFloat(L, anim.frameRate);
	return 1;
}
int DrawRectAnim_BindLua::GetFrameCount(lua_State* L)
{
	LuaScript::SSetInt(L, anim.frameCount);
	return 1;
}
int DrawRectAnim_BindLua::GetHorizontalFrameCount(lua_State* L)
{
	LuaScript::SSetInt(L, anim.horizontalFrameCount);
	return 1;
}
