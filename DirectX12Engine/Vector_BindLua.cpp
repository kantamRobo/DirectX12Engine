...
Vector_BindLua::Vector_BindLua(lua_State* L)
{
	...
	if (argc > 0)
	{
		x = LuaScript::SGetFloat(L, 1);
		if (argc > 1)
		{
			y = LuaScript::SGetFloat(L, 2);
			if (argc > 2)
			{
				z = LuaScript::SGetFloat(L, 3);
				if (argc > 3)
				{
					w = LuaScript::SGetFloat(L, 4);
				}
			}
		}
	}
...
{
	LuaScript::SSetFloat(L, XMVectorGetX(vector));
	return 1;
}
int Vector_BindLua::GetY(lua_State* L)
{
	LuaScript::SSetFloat(L, XMVectorGetY(vector));
	return 1;
}
int Vector_BindLua::GetZ(lua_State* L)
{
	LuaScript::SSetFloat(L, XMVectorGetZ(vector));
	return 1;
}
int Vector_BindLua::GetW(lua_State* L)
{
	LuaScript::SSetFloat(L, XMVectorGetW(vector));
	return 1;
}
...
int Vector_BindLua::SetX(lua_State* L)
{
	...
	if (argc > 0)
	{
		vector = XMVectorSetX(vector, LuaScript::SGetFloat(L, 1));
	}
	else
		LuaScript::SError(L, "SetX(float value) not enough arguments!");
	return 0;
}
int Vector_BindLua::SetY(lua_State* L)
{
	...
	if (argc > 0)
	{
		vector = XMVectorSetY(vector, LuaScript::SGetFloat(L, 1));
	}
	else
		LuaScript::SError(L, "SetY(float value) not enough arguments!");
	return 0;
}
int Vector_BindLua::SetZ(lua_State* L)
{
	...
	if (argc > 0)
	{
		vector = XMVectorSetZ(vector, LuaScript::SGetFloat(L, 1));
	}
	else
		LuaScript::SError(L, "SetZ(float value) not enough arguments!");
	return 0;
}
int Vector_BindLua::SetW(lua_State* L)
{
	...
	if (argc > 0)
	{
		vector = XMVectorSetW(vector, LuaScript::SGetFloat(L, 1));
	}
	else
		LuaScript::SError(L, "SetW(float value) not enough arguments!");
	return 0;
}
...
int Vector_BindLua::Transform(lua_State* L)
{
	...
	if (argc > 1)
	{
		...
		if (vec && mat)
		{
			...
			LuaScript::SError(L, "Transform(Vector vec, Matrix matrix) argument types mismatch!");
	}
	else
		LuaScript::SError(L, "Transform(Vector vec, Matrix matrix) not enough arguments!");
	return 0;
}
int Vector_BindLua::TransformNormal(lua_State* L)
{
	...
	if (argc > 1)
	{
		...
		if (vec && mat)
		{
			...
			LuaScript::SError(L, "TransformNormal(Vector vec, Matrix matrix) argument types mismatch!");
	}
	else
		LuaScript::SError(L, "TransformNormal(Vector vec, Matrix matrix) not enough arguments!");
	return 0;
}
int Vector_BindLua::TransformCoord(lua_State* L)
{
	...
	if (argc > 1)
	{
		...
		if (vec && mat)
		{
			...
			LuaScript::SError(L, "TransformCoord(Vector vec, Matrix matrix) argument types mismatch!");
	}
	else
		LuaScript::SError(L, "TransformCoord(Vector vec, Matrix matrix) not enough arguments!");
	return 0;
}
int Vector_BindLua::Length(lua_State* L)
{
	LuaScript::SSetFloat(L, XMVectorGetX(XMVector3Length(vector)));
	return 1;
}
...
int Vector_BindLua::Clamp(lua_State* L)
{
	...
	if (argc > 1)
	{
		float a = LuaScript::SGetFloat(L, 1);
		float b = LuaScript::SGetFloat(L, 2);
		Luna<Vector_BindLua>::push(L, new Vector_BindLua(XMVectorClamp(vector, XMVectorSet(a, a, a, a), XMVectorSet(b, b, b, b))));
		return 1;
	}
	else
		LuaScript::SError(L, "Clamp(float min,max) not enough arguments!");
	return 0;
}
...
int Vector_BindLua::Dot(lua_State* L)
{
	...
	if (argc > 1)
	{
		...
		if (v1 && v2)
		{
			LuaScript::SSetFloat(L, XMVectorGetX(XMVector3Dot(v1->vector, v2->vector)));
			return 1;
		}
	}
	LuaScript::SError(L, "Dot(Vector v1,v2) not enough arguments!");
	return 0;
}
int Vector_BindLua::Cross(lua_State* L)
{
	...
	LuaScript::SError(L, "Cross(Vector v1,v2) not enough arguments!");
	return 0;
}
int Vector_BindLua::Multiply(lua_State* L)
{
	...
	if (argc > 1)
	{
		...
		{
			Luna<Vector_BindLua>::push(L, new Vector_BindLua(v1->vector * LuaScript::SGetFloat(L, 2)));
			return 1;
		}
		else if (v2)
		{
			Luna<Vector_BindLua>::push(L, new Vector_BindLua(LuaScript::SGetFloat(L, 1) * v2->vector));
			return 1;
		}
	}
	LuaScript::SError(L, "Multiply(Vector v1,v2) not enough arguments!");
	return 0;
}
int Vector_BindLua::Add(lua_State* L)
{
	...
	LuaScript::SError(L, "Add(Vector v1,v2) not enough arguments!");
	return 0;
}
int Vector_BindLua::Subtract(lua_State* L)
{
	...
	LuaScript::SError(L, "Subtract(Vector v1,v2) not enough arguments!");
	return 0;
}
int Vector_BindLua::Lerp(lua_State* L)
{
	...
	if (argc > 2)
	{
		Vector_BindLua* v1 = Luna<Vector_BindLua>::lightcheck(L, 1);
		Vector_BindLua* v2 = Luna<Vector_BindLua>::lightcheck(L, 2);
		float t = LuaScript::SGetFloat(L, 3);
		if (v1 && v2)
		{
	...
	LuaScript::SError(L, "Lerp(Vector v1,v2, float t) not enough arguments!");
	return 0;
}
...
int Vector_BindLua::QuaternionMultiply(lua_State* L)
{
	...
	LuaScript::SError(L, "QuaternionMultiply(Vector v1,v2) not enough arguments!");
	return 0;
}
int Vector_BindLua::QuaternionFromRollPitchYaw(lua_State* L)
{
	...
	LuaScript::SError(L, "QuaternionFromRollPitchYaw(Vector rotXYZ) not enough arguments!");
	return 0;
}
int Vector_BindLua::Slerp(lua_State* L)
{
	...
	LuaScript::SError(L, "QuaternionSlerp(Vector v1,v2, float t) not enough arguments!");
	return 0;
}
...
void Vector_BindLua::Bind()
{
	...
	{
		initialized = true;
		Luna<Vector_BindLua>::Register(LuaScript::GetLuaState());
		LuaScript::RunText("vector = Vector()");
	}
}
