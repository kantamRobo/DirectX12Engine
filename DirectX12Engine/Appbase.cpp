...
void AppBase::PrepareRenderTargetView()
{
...
void AppBase::CreateDepthBuffer(int width, int height)
{
	// デプスバッファの生成
...
void AppBase::CreateFrameFences()
{
	HRESULT hr;
...
void AppBase::WaitPreviousFrame()
{
...
HRESULT AppBase::CompileShaderFromFile(
