...
Microsoft::WRL::ComPtr<ID3D12Resource1> CubeApp::CreateBuffer(UINT bufferSize, const void* initialData)
{
	HRESULT hr;
...
// 手動で生成版
Microsoft::WRL::ComPtr<ID3D12Resource1> CubeApp::CreateTexture(const std::string& fileName)
{
