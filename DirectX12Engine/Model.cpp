...
Microsoft::WRL::ComPtr<ID3D12Resource1> Model::CreateBuffer(ID3D12Device* p_device,UINT bufferSize, const void* initialData)
{
	...
	// èâä˙ÉfÅ[É^ÇÃéwíËÇ™Ç†ÇÈÇ∆Ç´Ç…ÇÕÉRÉsÅ[Ç∑ÇÈ
...
{
	// CBV/SRV ÇÃÉfÉBÉXÉNÉäÉvÉ^ÉqÅ[Év
	//  0:ÉVÉFÅ[É_Å[ÉäÉ\Å[ÉXÉrÉÖÅ[
	//  1,2 : íËêîÉoÉbÉtÉ@ÉrÉÖÅ[ (FrameBufferCountêîï™égóp)
	...
	// É_ÉCÉiÉ~ÉbÉNÉTÉìÉvÉâÅ[ÇÃÉfÉBÉXÉNÉäÉvÉ^ÉqÅ[Év
...
Microsoft::WRL::ComPtr<ID3D12Resource1> Model::CreateTexture(const std::wstring& fileName,ID3D12Device* p_device,const Commands& in_commands,UINT in_frameIndex)
{
	...
	// ÉTÉCÉYÅEÉtÉHÅ[É}ÉbÉgÇ©ÇÁÉeÉNÉXÉ`ÉÉÉäÉ\Å[ÉXÇÃDescèÄîı
	...
	//GPUÉAÉbÉvÉçÅ[ÉhÉoÉbÉtÉ@(íÜä‘ÉoÉbÉtÉ@ÅjÇçÏê¨
	p_device->CreateCommittedResource(
